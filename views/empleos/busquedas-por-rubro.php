...
<table class="table table-hover table-striped">
    ...
    <?php foreach ($busquedas as $busqueda): ?>
        <tr>
            ...
            <td><a href="form-inscripciones?idBusqueda=<?= $busqueda->idBusqueda ?>"
                   class="btn btn-success active" role="button" aria-pressed="true">Inscribirse</a>
                <a href="ver-inscripciones-trabajo?id=<?= $busqueda->idBusqueda ?>"
                   class="btn btn-primary ml-1" role="button" aria-pressed="true">Ver Inscriptos</a></td>
        </tr>
    <?php endforeach; ?>
    </tbody>
</table>
